...
In early 2024, Noah and I already knew based on our many conversations with realtors that prequalifying prospective tenants before scheduling a tour was a huge time-suck and pain point for them. We had decided that this was the problem we were going to solve. What we wrongly assumed however, was that their communication happened over email and text.
...
[^1]: We even had a meeting with a couple representatives from Zillow Group, where we tried to get some sort of deal or exception to this rule. That unfortunately didn't lead anywhere, probably because we were two 22 year olds with 0 paying customers and hardly even a working product.
